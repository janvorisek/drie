    ...
    <div class="example">
      <Renderer :antialias="true" :on-before-render="onBeforeRender">
        ...
        <Scene background="#f9f9f9">
          ...
          <LineSegments v-if="PARAMS.object === 'CircleGeometry'" :position="position" :rotation="rotation" :scale="scale">
          ...
          <LineSegments v-if="PARAMS.object === 'ConeGeometry'" :position="position" :rotation="rotation" :scale="scale">
          ...
          <LineSegments v-if="PARAMS.object === 'CylinderGeometry'" :position="position" :rotation="rotation" :scale="scale">
          ...
          <LineSegments v-if="PARAMS.object === 'PlaneGeometry'" :position="position" :rotation="rotation" :scale="scale">
          ...
          <LineSegments v-if="PARAMS.object === 'RingGeometry'" :position="position" :rotation="rotation" :scale="scale">
          ...
          <LineSegments v-if="PARAMS.object === 'SphereGeometry'" :position="position" :rotation="rotation" :scale="scale">
...
import { BoxGeometry, CircleGeometry, ConeGeometry, CylinderGeometry, PlaneGeometry, RingGeometry, SphereGeometry } from "../../src";
