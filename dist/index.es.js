import { watch as F, inject as S, onMounted as oe, onUnmounted as _e, defineComponent as C, ref as He, reactive as fe, provide as N, openBlock as ds, createElementBlock as hs, Fragment as fs, createElementVNode as ps, renderSlot as J, shallowRef as ms } from "vue";
import { Vector3 as v, Raycaster as Vt, Vector2 as U, WebGLRenderer as gs, Scene as ys, Color as V, PerspectiveCamera as zn, OrthographicCamera as Un, EventDispatcher as Bn, MOUSE as Le, TOUCH as $e, Quaternion as le, Spherical as hn, Euler as _s, Matrix4 as vt, Object3D as Tt, MeshBasicMaterial as ye, LineBasicMaterial as Pe, CylinderGeometry as ie, BoxGeometry as se, BufferGeometry as B, Float32BufferAttribute as ge, Mesh as x, OctahedronGeometry as gt, Line as Ee, SphereGeometry as Xn, TorusGeometry as Je, PlaneGeometry as Yn, DoubleSide as Vn, Group as Ue, InstancedMesh as ws, LineLoop as Zn, LineSegments as St, PointsMaterial as ze, Points as ct, Loader as $n, LoaderUtils as Be, FileLoader as Jt, SpotLight as bs, PointLight as qn, DirectionalLight as Kn, sRGBEncoding as Xe, MeshPhysicalMaterial as Ye, TangentSpaceNormalMap as Es, Interpolant as Ms, TextureLoader as Qn, ImageBitmapLoader as Ts, InterleavedBuffer as Ss, InterleavedBufferAttribute as vs, BufferAttribute as lt, LinearFilter as Wn, LinearMipmapLinearFilter as Jn, RepeatWrapping as Zt, Material as ut, MeshStandardMaterial as en, PropertyBinding as xs, SkinnedMesh as As, MathUtils as Rs, InterpolateLinear as es, AnimationClip as Ls, Bone as Ps, Skeleton as Cs, TriangleFanDrawMode as ts, NearestFilter as Is, NearestMipmapNearestFilter as Os, LinearMipmapNearestFilter as ks, NearestMipmapLinearFilter as Ds, ClampToEdgeWrapping as $t, MirroredRepeatWrapping as Hs, InterpolateDiscrete as js, FrontSide as xt, Texture as qt, TriangleStripDrawMode as Ns, VectorKeyframeTrack as Fs, QuaternionKeyframeTrack as fn, NumberKeyframeTrack as Gs, Box3 as ns, Sphere as zs, MeshPhongMaterial as Us, AxesHelper as Bs, CircleGeometry as Xs, ConeGeometry as Ys, EdgesGeometry as Vs, Curve as Zs, RingGeometry as $s, WireframeGeometry as qs, LineDashedMaterial as Ks, MeshLambertMaterial as Qs, MeshNormalMaterial as Ws, AmbientLight as Js, HemisphereLight as eo } from "three";
const pn = (r) => r === void 0 ? new v(0, 0, 0) : "x" in r ? new v(r.x, r.y, r.z) : new v(r[0], r[1], r[2]), mn = (r) => r === void 0 ? new U(0, 0) : "x" in r ? new U(r.x, r.y) : new U(r[0], r[1]), gn = (r, n, t) => {
...
function pe(r, n) {
  n.hasAttribute("position") && (r.setAttribute("position", n.getAttribute("position")), r.attributes.position.needsUpdate = !0), n.hasAttribute("normal") && (r.setAttribute("normal", n.getAttribute("normal")), r.attributes.normal.needsUpdate = !0), n.hasAttribute("uv") && (r.setAttribute("uv", n.getAttribute("uv")), r.attributes.uv.needsUpdate = !0), r.setIndex(n.getIndex());
}
function Me(r) {
...
function tn(r, n) {
  ...
  let i = !1, o = [];
  const a = (c) => {
    if (n.onMouseEnter === null && n.onMouseMove === null && n.onMouseLeave === null)
      return;
    const l = new Vt(), d = wn(c);
    l.setFromCamera(d, t.value);
    const u = l.intersectObjects(r);
    u.length > 0 ? (o = u, i === !1 && n.onMouseEnter !== null && n.onMouseEnter(u, d), i = !0, n.onMouseLeave !== null && n.onMouseMove(u, d)) : (i && n.onMouseLeave !== null && n.onMouseLeave(o, d), i = !1, o = []);
  };
  oe(() => {
    if (n.enableRaycasting) {
      if ((e == null ? void 0 : e.value) == null)
        return;
      e == null || e.value.addEventListener("click", s), e == null || e.value.addEventListener("mousemove", a);
    }
  }), _e(() => {
    if (n.enableRaycasting) {
      if ((e == null ? void 0 : e.value) == null)
...
function to(r, n) {
  ...
  }) : n.length === 1 ? bn(n[0], r) : Promise.all(n.map((t) => bn(t, r)));
}
var ht = {};
...
Ve.defaultSlotConfig = ss;
const oo = (r) => Object.assign(() => Ht(), {
  config: r,
  lazy: () => Ht,
  on: () => Ht,
  slotName: "Not connected"
}), et = "LOCAL_TRANSPORT", tt = (r, n) => Object.keys(n).reduce((t, e) => t.concat(n[e][r] || []), []), En = (r) => Object.keys(r).reduce((n, t) => {
...
function ao(r, n, t = {}) {
  ...
  n.forEach((h, m) => {
    const g = (w = yt.DEFAULT_PARAM, M) => {
      ...
      const T = (e[m][w] || []).indexOf(M);
      T > -1 && e[m][w].splice(T, 1), tt(w, e).length === 0 && l(w), s[m] && i(String(m), w);
    }, y = () => {
  ...
  function d(h, m) {
      ...
      return Promise.all(M).then(() => w());
    {
      ...
      const A = n.reduce((T, O, j) => {
        var D;
        return [...T, ...(D = s[j] && [s[j][y].registered]) !== null && D !== void 0 ? D : []];
      }, []);
      return Promise.all(A).then(() => w());
    }
  }
  function u(h, m) {
    return o.push(h), a.push(m), En(e).forEach(h), () => {
      En(e).forEach(m);
      const g = o.indexOf(h);
      g > -1 && o.splice(g, 1);
      const b = a.indexOf(m);
  ...
  function f(h, m) {
    ...
    return typeof h == "string" ? (g = h, b = m || b) : (g = yt.DEFAULT_PARAM, b = h), n.forEach((w) => w.registerHandler(r, g, b)), e[et][g] = (e[et][g] || []).concat(b), tt(g, e).length === 1 && c(g), () => {
      n.forEach((T) => T.unregisterHandler(r, g, b));
...
class ho {
  ...
  _requestReceived({
    ...
    if (!i)
      return;
    const o = i[s];
    o && (0, ro.callHandlers)(t, o).then((a) => this._channel.send({
      type: "response",
      slotName: n,
      id: e,
      data: a,
...
function go(r) {
  const n = (r.channels || []).map((e) => new po.Transport(e, r.ignoredEvents)), t = {};
  for (const e in r.events)
    r.events.hasOwnProperty(e) && (!r.ignoredEvents || r.ignoredEvents && !r.ignoredEvents.includes(e)) && (t[e] = (0, fo.connectSlot)(e, n, r.events[e].config));
  return t;
}
var yo = {}, ft = {};
...
ft.GenericChannel = wo;
var Pt = {}, Ct = {};
Object.defineProperty(Ct, "__esModule", {
  value: !0
});
Ct.isTransportMessage = bo;
function bo(r) {
  switch (r.type) {
    case "request":
    case "response":
...
class To extends Eo.GenericChannel {
  constructor(n) {
...
(function(r) {
  ...
  var n = Ve, t = Rt, e = yo, s = ft, i = Pt, o = Ct, a = ht;
})(Re);
const So = {
  ...
  setup(r, { expose: n }) {
    ...
    oe(() => {
      e.value = new gs({ canvas: d.value, antialias: t.antialias, alpha: t.alpha }), e.value.setSize(1, 1), g(), m(t.camera), new ResizeObserver((w) => {
        w.forEach((M) => {
    ...
    return g(), F(
      ...
      () => t.height,
      () => g()
    ), N("addCamera", (y) => c.value.push(y)), N("addScene", (y) => s.push(y)), N("addGeometry", (y) => i.push(y)), N("getGeometry", (y) => i.find((w) => w.name === y)), N("addMaterial", (y) => o.push(y)), N("getMaterial", (y) => o.find((w) => w.name === y)), N("addControls", (y) => l.value.push(y)), N("enableAllControls", () => {
      u = !0;
    }), N("disableAllControls", () => {
      u = !1;
    }), N("camera", a), n({
      three: e,
      eventBus: k
  ...
  setup(r, { expose: n }) {
    ...
    return s(t), F(
      () => t.background,
      () => s(t)
    ), n({ three: e }), (i, o) => J(i.$slots, "default");
  }
}), Ao = {
  ...
  setup(r, { expose: n }) {
    const t = r, e = new zn(75, window.innerWidth / window.innerHeight * 1e3, 0.1, 1e3);
    S("addCamera")(e);
    const s = S("canvas");
    F(s, () => {
    ...
    return i(), _(t, "name", i), _(t, "aspect", i), _(t, "near", i), _(t, "far", i), N("parentCamera", e), n({ three: e }), (o, a) => J(o.$slots, "default");
  }
}), Lo = {
  ...
  setup(r, { expose: n }) {
    const t = r, e = new Un(-10, 10, 10, -10, 0.1, 1e3);
...
class Co extends Bn {
  constructor(n, t) {
    super(), t === void 0 && console.warn('THREE.OrbitControls: The second parameter "domElement" is now mandatory.'), t === document && console.error('THREE.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.'), this.object = n, this.domElement = t, this.domElement.style.touchAction = "none", this.enabled = !0, this.target = new v(), this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = 0.05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = { LEFT: "ArrowLeft", UP: "ArrowUp", RIGHT: "ArrowRight", BOTTOM: "ArrowDown" }, this.mouseButtons = { LEFT: Le.ROTATE, MIDDLE: Le.DOLLY, RIGHT: Le.PAN }, this.touches = { ONE: $e.ROTATE, TWO: $e.DOLLY_PAN }, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._domElementKeyEvents = null, this.getPolarAngle = function() {
      ...
      e.target.copy(e.target0), e.object.position.copy(e.position0), e.object.zoom = e.zoom0, e.object.updateProjectionMatrix(), e.dispatchEvent(Mn), e.update(), i = s.NONE;
    }, this.update = function() {
      const p = new v(), R = new le().setFromUnitVectors(n.up, new v(0, 1, 0)), W = R.clone().invert(), ne = new v(), me = new le(), Ze = 2 * Math.PI;
      return function() {
        const dn = e.object.position;
        p.copy(dn).sub(e.target), p.applyQuaternion(R), a.setFromVector3(p), e.autoRotate && i === s.NONE && K(j()), e.enableDamping ? (a.theta += c.theta * e.dampingFactor, a.phi += c.phi * e.dampingFactor) : (a.theta += c.theta, a.phi += c.phi);
        let ve = e.minAzimuthAngle, xe = e.maxAzimuthAngle;
        return isFinite(ve) && isFinite(xe) && (ve < -Math.PI ? ve += Ze : ve > Math.PI && (ve -= Ze), xe < -Math.PI ? xe += Ze : xe > Math.PI && (xe -= Ze), ve <= xe ? a.theta = Math.max(ve, Math.min(xe, a.theta)) : a.theta = a.theta > (ve + xe) / 2 ? Math.max(ve, a.theta) : Math.min(xe, a.theta)), a.phi = Math.max(e.minPolarAngle, Math.min(e.maxPolarAngle, a.phi)), a.makeSafe(), a.radius *= l, a.radius = Math.max(e.minDistance, Math.min(e.maxDistance, a.radius)), e.enableDamping === !0 ? e.target.addScaledVector(d, e.dampingFactor) : e.target.add(d), p.setFromSpherical(a), p.applyQuaternion(W), dn.copy(e.target).add(p), e.object.lookAt(e.target), e.enableDamping === !0 ? (c.theta *= 1 - e.dampingFactor, c.phi *= 1 - e.dampingFactor, d.multiplyScalar(1 - e.dampingFactor)) : (c.set(0, 0, 0), d.set(0, 0, 0)), l = 1, u || ne.distanceToSquared(e.object.position) > o || 8 * (1 - me.dot(e.object.quaternion)) > o ? (e.dispatchEvent(Mn), ne.copy(e.object.position), me.copy(e.object.quaternion), u = !1, !0) : !1;
      };
    ...
    let i = s.NONE;
    const o = 1e-6, a = new hn(), c = new hn();
    let l = 1;
    const d = new v();
    let u = !1;
    const f = new U(), h = new U(), m = new U(), g = new U(), b = new U(), y = new U(), w = new U(), M = new U(), A = new U(), T = [], O = {};
    function j() {
    ...
    const Z = function() {
      ...
      return function(W, ne) {
        p.setFromMatrixColumn(ne, 0), p.multiplyScalar(-W), d.add(p);
      };
    }(), ae = function() {
      const p = new v();
      return function(W, ne) {
        e.screenSpacePanning === !0 ? p.setFromMatrixColumn(ne, 1) : (p.setFromMatrixColumn(ne, 0), p.crossVectors(e.object.up, p)), p.multiplyScalar(W), d.add(p);
      };
    }(), X = function() {
      const p = new v();
      return function(W, ne) {
        ...
        if (e.object.isPerspectiveCamera) {
          ...
          p.copy(Ze).sub(e.target);
          let mt = p.length();
          mt *= Math.tan(e.object.fov / 2 * Math.PI / 180), Z(2 * W * mt / me.clientHeight, e.object.matrix), ae(2 * ne * mt / me.clientHeight, e.object.matrix);
        } else
          e.object.isOrthographicCamera ? (Z(W * (e.object.right - e.object.left) / e.object.zoom / me.clientWidth, e.object.matrix), ae(ne * (e.object.top - e.object.bottom) / e.object.zoom / me.clientHeight, e.object.matrix)) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."), e.enablePan = !1);
      };
    }();
    function $(p) {
    ...
    function Q(p) {
      ...
      K(2 * Math.PI * m.x / R.clientHeight), H(2 * Math.PI * m.y / R.clientHeight), f.copy(h), e.update();
    }
    function Ce(p) {
      M.set(p.clientX, p.clientY), A.subVectors(M, w), A.y > 0 ? $(D()) : A.y < 0 && z(D()), w.copy(M), e.update();
    }
    function Ie(p) {
      b.set(p.clientX, p.clientY), y.subVectors(b, g).multiplyScalar(e.panSpeed), X(y.x, y.y), g.copy(b), e.update();
    }
    function Se(p) {
      p.deltaY < 0 ? z(D()) : p.deltaY > 0 && $(D()), e.update();
    }
    function Qe(p) {
      let R = !1;
      switch (p.code) {
    ...
    function Oe() {
      if (T.length === 1)
        ...
        const p = 0.5 * (T[0].pageX + T[1].pageX), R = 0.5 * (T[0].pageY + T[1].pageY);
        f.set(p, R);
      }
    }
    function We() {
    ...
    function pt() {
      const p = T[0].pageX - T[1].pageX, R = T[0].pageY - T[1].pageY, W = Math.sqrt(p * p + R * R);
      w.set(0, W);
    }
    function E() {
    ...
    function q(p) {
      if (T.length == 1)
        ...
        const W = Dt(p), ne = 0.5 * (p.pageX + W.x), me = 0.5 * (p.pageY + W.y);
        h.set(ne, me);
      }
      m.subVectors(h, f).multiplyScalar(e.rotateSpeed);
      const R = e.domElement;
      K(2 * Math.PI * m.x / R.clientHeight), H(2 * Math.PI * m.y / R.clientHeight), f.copy(h);
    }
    function te(p) {
      if (T.length === 1)
        b.set(p.pageX, p.pageY);
      else {
        const R = Dt(p), W = 0.5 * (p.pageX + R.x), ne = 0.5 * (p.pageY + R.y);
        b.set(W, ne);
      }
      y.subVectors(b, g).multiplyScalar(e.panSpeed), X(y.x, y.y), g.copy(b);
    }
    function de(p) {
      const R = Dt(p), W = p.pageX - R.x, ne = p.pageY - R.y, me = Math.sqrt(W * W + ne * ne);
      M.set(0, me), A.set(0, Math.pow(M.y / w.y, e.zoomSpeed)), $(A.y), w.copy(M);
    }
    function we(p) {
      e.enableZoom && de(p), e.enablePan && te(p);
    }
    function sn(p) {
      e.enableZoom && de(p), e.enableRotate && q(p);
    }
    function je(p) {
      e.enabled !== !1 && (T.length === 0 && (e.domElement.setPointerCapture(p.pointerId), e.domElement.addEventListener("pointermove", Ot), e.domElement.addEventListener("pointerup", kt)), us(p), p.pointerType === "touch" ? cs(p) : as(p));
    }
    function Ot(p) {
      e.enabled !== !1 && (p.pointerType === "touch" ? ls(p) : rs(p));
    }
    function kt(p) {
      ln(p), T.length === 0 && (e.domElement.releasePointerCapture(p.pointerId), e.domElement.removeEventListener("pointermove", Ot), e.domElement.removeEventListener("pointerup", kt)), e.dispatchEvent(Tn), i = s.NONE;
    }
    function on(p) {
      ln(p);
    }
    ...
    function an(p) {
      e.enabled === !1 || e.enableZoom === !1 || i !== s.NONE || (p.preventDefault(), e.dispatchEvent(Nt), Se(p), e.dispatchEvent(Tn));
    }
    function rn(p) {
      e.enabled === !1 || e.enablePan === !1 || Qe(p);
    }
    function cs(p) {
      switch (un(p), T.length) {
        case 1:
    ...
    function Dt(p) {
      const R = p.pointerId === T[0].pointerId ? T[1] : T[0];
...
const Io = {
  ...
  setup(r, { expose: n }) {
    ...
    let a = !1;
    const c = () => {
      i.value && (a || (e.value = new Co(s, i.value), o(), L(t, "target", e.value), a = !0));
    };
    return F(i, () => {
      c();
...
class ko extends Bn {
  constructor(n, t) {
    ...
    const h = new v(), m = new U(), g = new U(), b = new v(), y = new U(), w = new U(), M = new U(), A = new U(), T = [], O = {};
    ...
    this.rotateCamera = function() {
      const E = new v(), P = new le(), q = new v(), te = new v(), de = new v(), we = new v();
      return function() {
        we.set(g.x - m.x, g.y - m.y, 0);
        let je = we.length();
        je ? (h.copy(e.object.position).sub(e.target), q.copy(h).normalize(), te.copy(e.object.up).normalize(), de.crossVectors(te, q).normalize(), te.setLength(g.y - m.y), de.setLength(g.x - m.x), we.copy(te.add(de)), E.crossVectors(we, h).normalize(), je *= e.rotateSpeed, P.setFromAxisAngle(E, je), h.applyQuaternion(P), e.object.up.applyQuaternion(P), b.copy(E), f = je) : !e.staticMoving && f && (f *= Math.sqrt(1 - e.dynamicDampingFactor), h.copy(e.object.position).sub(e.target), P.setFromAxisAngle(b, f), h.applyQuaternion(P), e.object.up.applyQuaternion(P)), m.copy(g);
      };
      ...
      return function() {
        if (E.copy(A).sub(M), E.lengthSq()) {
          if (e.object.isOrthographicCamera) {
            const de = (e.object.right - e.object.left) / e.object.zoom / e.domElement.clientWidth, we = (e.object.top - e.object.bottom) / e.object.zoom / e.domElement.clientWidth;
            E.x *= de, E.y *= we;
          }
    ...
    function K(E) {
      e.enabled !== !1 && (T.length === 0 && (e.domElement.setPointerCapture(E.pointerId), e.domElement.addEventListener("pointermove", H), e.domElement.addEventListener("pointerup", Z)), Qe(E), E.pointerType === "touch" ? Q(E) : z(E));
    }
    function H(E) {
      e.enabled !== !1 && (E.pointerType === "touch" ? Ce(E) : ue(E));
    }
    function Z(E) {
      e.enabled !== !1 && (E.pointerType === "touch" ? Ie(E) : ee(), Oe(E), T.length === 0 && (e.domElement.releasePointerCapture(E.pointerId), e.domElement.removeEventListener("pointermove", H), e.domElement.removeEventListener("pointerup", Z)));
    }
    function ae(E) {
      Oe(E);
    }
    ...
    function z(E) {
      ...
      P === s.ROTATE && !e.noRotate ? (g.copy(D(E.pageX, E.pageY)), m.copy(g)) : P === s.ZOOM && !e.noZoom ? (y.copy(j(E.pageX, E.pageY)), w.copy(y)) : P === s.PAN && !e.noPan && (M.copy(j(E.pageX, E.pageY)), A.copy(M)), e.dispatchEvent(Gt);
    }
    function ue(E) {
      const P = l !== s.NONE ? l : c;
      P === s.ROTATE && !e.noRotate ? (m.copy(g), g.copy(D(E.pageX, E.pageY))) : P === s.ZOOM && !e.noZoom ? w.copy(j(E.pageX, E.pageY)) : P === s.PAN && !e.noPan && A.copy(j(E.pageX, E.pageY));
    }
    function ee() {
    ...
    function Q(E) {
      switch (We(E), T.length) {
        case 1:
          c = s.TOUCH_ROTATE, g.copy(D(T[0].pageX, T[0].pageY)), m.copy(g);
          break;
        default:
          c = s.TOUCH_ZOOM_PAN;
          const P = T[0].pageX - T[1].pageX, q = T[0].pageY - T[1].pageY;
          u = d = Math.sqrt(P * P + q * q);
          const te = (T[0].pageX + T[1].pageX) / 2, de = (T[0].pageY + T[1].pageY) / 2;
          M.copy(j(te, de)), A.copy(M);
          break;
      }
      e.dispatchEvent(Gt);
    }
    function Ce(E) {
      switch (We(E), T.length) {
        ...
        default:
          ...
          const de = (E.pageX + P.x) / 2, we = (E.pageY + P.y) / 2;
          A.copy(j(de, we));
          break;
      }
    }
    ...
    this.dispose = function() {
      e.domElement.removeEventListener("contextmenu", Se), e.domElement.removeEventListener("pointerdown", K), e.domElement.removeEventListener("pointercancel", ae), e.domElement.removeEventListener("wheel", re), e.domElement.removeEventListener("pointermove", H), e.domElement.removeEventListener("pointerup", Z), window.removeEventListener("keydown", X), window.removeEventListener("keyup", $);
    }, this.domElement.addEventListener("contextmenu", Se), this.domElement.addEventListener("pointerdown", K), this.domElement.addEventListener("pointercancel", ae), this.domElement.addEventListener("wheel", re, { passive: !1 }), window.addEventListener("keydown", X), window.addEventListener("keyup", $), this.handleResize(), this.update();
  }
}
const Do = {
...
}), Ne = new Vt(), ce = new v(), ke = new v(), Y = new le(), Sn = {
  X: new v(1, 0, 0),
  Y: new v(0, 1, 0),
  Z: new v(0, 0, 1)
}, Ut = { type: "change" }, vn = { type: "mouseDown" }, xn = { type: "mouseUp", mode: null }, An = { type: "objectChange" };
class jo extends Tt {
  constructor(n, t) {
    ...
    function o(w, M) {
      ...
      Object.defineProperty(i, w, {
        ...
        set: function(T) {
          A !== T && (A = T, s[w] = T, e[w] = T, i.dispatchEvent({ type: w + "-changed", value: T }), i.dispatchEvent(Ut));
        }
      }), i[w] = M, s[w] = M, e[w] = M;
    }
  ...
  pointerMove(n) {
    ...
    if (o) {
      if (this.pointEnd.copy(o.point).sub(this.worldPositionStart), e === "translate")
        ...
        t === "E" ? (this.rotationAxis.copy(this.eye), this.rotationAngle = this.pointEnd.angleTo(this.pointStart), this._startNorm.copy(this.pointStart).normalize(), this._endNorm.copy(this.pointEnd).normalize(), this.rotationAngle *= this._endNorm.cross(this._startNorm).dot(this.eye) < 0 ? 1 : -1) : t === "XYZE" ? (this.rotationAxis.copy(this._offset).cross(this.eye).normalize(), this.rotationAngle = this._offset.dot(ce.copy(this.rotationAxis).cross(this.eye)) * a) : (t === "X" || t === "Y" || t === "Z") && (this.rotationAxis.copy(Sn[t]), ce.copy(Sn[t]), i === "local" && ce.applyQuaternion(this.worldQuaternion), this.rotationAngle = this._offset.dot(ce.cross(this.eye).normalize()) * a), this.rotationSnap && (this.rotationAngle = Math.round(this.rotationAngle / this.rotationSnap) * this.rotationSnap), i === "local" && t !== "E" && t !== "XYZE" ? (s.quaternion.copy(this._quaternionStart), s.quaternion.multiply(Y.setFromAxisAngle(this.rotationAxis, this.rotationAngle)).normalize()) : (this.rotationAxis.applyQuaternion(this._parentQuaternionInv), s.quaternion.copy(Y.setFromAxisAngle(this.rotationAxis, this.rotationAngle)), s.quaternion.multiply(this._quaternionStart).normalize());
      }
      this.dispatchEvent(Ut), this.dispatchEvent(An);
    }
  }
  pointerUp(n) {
  ...
  reset() {
    this.enabled && this.dragging && (this.object.position.copy(this._positionStart), this.object.quaternion.copy(this._quaternionStart), this.object.scale.copy(this._scaleStart), this.dispatchEvent(Ut), this.dispatchEvent(An), this.pointStart.copy(this.pointEnd));
  }
  getRaycaster() {
    return Ne;
  }
...
const _t = new _s(), G = new v(0, 1, 0), Rn = new v(0, 0, 0), Ln = new vt(), wt = new le(), Mt = new le(), be = new v(), Pn = new vt(), at = new v(1, 0, 0), Fe = new v(0, 1, 0), rt = new v(0, 0, 1), bt = new v(), nt = new v(), st = new v();
class Bo extends Tt {
  constructor() {
    ...
    const y = new B();
    y.setAttribute("position", new ge([0, 0, 0, 1, 0, 0], 3));
    const w = new ie(75e-4, 75e-4, 0.5, 3);
    w.translate(0, 0.25, 0);
    function M(z, ue) {
      const ee = new Je(z, 75e-4, 3, 64, ue * Math.PI * 2);
      return ee.rotateY(Math.PI / 2), ee.rotateX(Math.PI / 2), ee;
    }
    function A() {
      const z = new B();
      return z.setAttribute("position", new ge([0, 0, 0, 1, 1, 1], 3)), z;
    }
    const T = {
      X: [
      ...
      DELTA: [
        [new Ee(A(), s), null, null, null, "helper"]
      ],
      X: [
        [new Ee(y, s.clone()), [-1e3, 0, 0], null, [1e6, 1, 1], "helper"]
      ],
      Y: [
        [new Ee(y, s.clone()), [0, -1e3, 0], [0, 0, Math.PI / 2], [1e6, 1, 1], "helper"]
      ],
      Z: [
        [new Ee(y, s.clone()), [0, 0, -1e3], [0, -Math.PI / 2, 0], [1e6, 1, 1], "helper"]
      ]
    }, D = {
      XYZE: [
    ...
    function $(z) {
      ...
      for (const ee in z)
        for (let re = z[ee].length; re--; ) {
          const Q = z[ee][re][0].clone(), Ce = z[ee][re][1], Ie = z[ee][re][2], Se = z[ee][re][3], Qe = z[ee][re][4];
          Q.name = ee, Q.tag = Qe, Ce && Q.position.set(Ce[0], Ce[1], Ce[2]), Ie && Q.rotation.set(Ie[0], Ie[1], Ie[2]), Se && Q.scale.set(Se[0], Se[1], Se[2]), Q.updateMatrix();
          const Oe = Q.geometry.clone();
          Oe.applyMatrix4(Q.matrix), Q.geometry = Oe, Q.renderOrder = 1 / 0, Q.position.set(0, 0, 0), Q.rotation.set(0, 0, 0), Q.scale.set(1, 1, 1), ue.add(Q);
        }
      return ue;
    }
    this.gizmo = {}, this.picker = {}, this.helper = {}, this.add(this.gizmo.translate = $(T)), this.add(this.gizmo.rotate = $(D)), this.add(this.gizmo.scale = $(Z)), this.add(this.picker.translate = $(O)), this.add(this.picker.rotate = $(H)), this.add(this.picker.scale = $(ae)), this.add(this.helper.translate = $(j)), this.add(this.helper.rotate = $(K)), this.add(this.helper.scale = $(X)), this.picker.translate.visible = !1, this.picker.rotate.visible = !1, this.picker.scale.visible = !1;
  }
  updateMatrixWorld(n) {
...
class Xo extends x {
  constructor() {
    super(
      new Yn(1e5, 1e5, 2, 2),
      new ye({ visible: !1, wireframe: !0, side: Vn, transparent: !0, opacity: 0.1, toneMapped: !1 })
  ...
  updateMatrixWorld(n) {
    ...
    switch (this.position.copy(this.worldPosition), this.mode === "scale" && (t = "local"), bt.copy(at).applyQuaternion(t === "local" ? this.worldQuaternion : Mt), nt.copy(Fe).applyQuaternion(t === "local" ? this.worldQuaternion : Mt), st.copy(rt).applyQuaternion(t === "local" ? this.worldQuaternion : Mt), G.copy(nt), this.mode) {
      ...
      case "scale":
        switch (this.axis) {
          case "X":
            G.copy(this.eye).cross(bt), be.copy(bt).cross(G);
            break;
          case "Y":
            G.copy(this.eye).cross(nt), be.copy(nt).cross(G);
            break;
          case "Z":
            G.copy(this.eye).cross(st), be.copy(st).cross(G);
            break;
          case "XY":
            be.copy(st);
            break;
    ...
    be.length() === 0 ? this.quaternion.copy(this.cameraQuaternion) : (Pn.lookAt(ce.set(0, 0, 0), be, G), this.quaternion.setFromRotationMatrix(Pn)), super.updateMatrixWorld(n);
  }
}
const Yo = {
  ...
  setup(r, { expose: n }) {
    const t = r, e = ms(null), s = S("scene"), i = S("mesh", null), o = S("parent", void 0), a = S("camera"), c = S("canvas"), l = S("enableAllControls"), d = S("disableAllControls");
    function u() {
    ...
    let f = !1;
    const h = () => {
      !c.value && !a.value || f || (e.value = new jo(a.value, c.value), L(t, "position", e.value), i ? e.value.attach(i) : o && e.value.attach(o), e.value.addEventListener("dragging-changed", function(m) {
        m.value ? d() : l();
      }), s.add(e.value), u(), f = !0);
    };
    return F(
    ...
    ), u(), _(t, "mode", u), _(t, "size", u), _(t, "showX", u), _(t, "showY", u), _(t, "showZ", u), _(t, "rotationSnap", u), _(t, "translationSnap", u), _e(() => {
      s.remove(e.value), Me(e.value);
  ...
  setup(r, { expose: n }) {
    const t = r, e = new Ue();
    return Te(e), L(t, "position", e), L(t, "rotation", e), L(t, "scale", e), tn(e.children, t), N("parent", e), n({ three: e }), (s, i) => J(s.$slots, "default");
  }
}), $o = /* @__PURE__ */ C({
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new B(), i = new ye(), o = new ws(s, i, t.count);
    o.castShadow = !0, o.receiveShadow = !0, Te(o);
    function a() {
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new B(), i = new Pe({ color: "black" }), o = new Ee(s, i);
    return Te(o), L(t, "position", o), L(t, "rotation", o), L(t, "scale", o), _e(() => {
      e.remove(o), Me(o);
    }), N("mesh", o), n({ three: o }), (a, c) => J(a.$slots, "default");
  }
}), Ko = /* @__PURE__ */ C({
  __name: "LineLoop",
  props: {
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new B(), i = new Pe({ color: "black" }), o = new Zn(s, i);
    return Te(o), L(t, "position", o), L(t, "rotation", o), L(t, "scale", o), _e(() => {
      e.remove(o), Me(o);
    }), N("mesh", o), n({ three: o }), (a, c) => J(a.$slots, "default");
  }
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new B(), i = new Pe({ color: "black" }), o = new St(s, i);
    return Te(o), L(t, "position", o), L(t, "rotation", o), L(t, "scale", o), _e(() => {
      e.remove(o), Me(o);
    }), N("mesh", o), n({ three: o }), (a, c) => J(a.$slots, "default");
  }
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new B(), i = new ye(), o = new x(s, i);
    o.castShadow = !0, o.receiveShadow = !0, Te(o), L(t, "position", o), L(t, "rotation", o), L(t, "scale", o), _(t, "position", () => {
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new B(), i = new ze({ color: "red", sizeAttenuation: !1, size: 2 }), o = new ct(s, i);
    Te(o), L(t, "position", o), L(t, "rotation", o), L(t, "scale", o), _(t, "position", () => {
      k.object3DTranslated(t.name, o);
    }), _(t, "rotation", () => {
      k.object3DTranslated(t.name, o);
    }), _(t, "scale", () => {
    ...
    return a(), oe(() => {
      ...
      e.remove(o), Me(o);
    }), N("mesh", o), n({ three: o }), (c, l) => J(c.$slots, "default");
  }
});
class ei extends $n {
  constructor(n) {
  ...
  parse(n, t, e, s) {
    ...
    if (typeof n == "string")
      i = n;
    else if (Be.decodeText(new Uint8Array(n, 0, 4)) === os) {
      try {
        o[I.KHR_BINARY_GLTF] = new mi(n);
      } catch (u) {
        s && s(u);
        return;
      }
...
class ni {
  ...
  _loadLight(n) {
    ...
    switch (c.type) {
      case "directional":
        l = new Kn(d), l.target.position.set(0, 0, -1), l.add(l.target);
        break;
      case "point":
        l = new qn(d), l.distance = u;
        break;
      case "spot":
...
const os = "glTF", ot = 12, Cn = { JSON: 1313821514, BIN: 5130562 };
class mi {
  constructor(n) {
...
class _i {
  ...
  createMaterial(n) {
    const t = new Kt(n);
    return t.fog = !0, t.color = n.color, t.map = n.map === void 0 ? null : n.map, t.lightMap = null, t.lightMapIntensity = 1, t.aoMap = n.aoMap === void 0 ? null : n.aoMap, t.aoMapIntensity = 1, t.emissive = n.emissive, t.emissiveIntensity = n.emissiveIntensity === void 0 ? 1 : n.emissiveIntensity, t.emissiveMap = n.emissiveMap === void 0 ? null : n.emissiveMap, t.bumpMap = n.bumpMap === void 0 ? null : n.bumpMap, t.bumpScale = 1, t.normalMap = n.normalMap === void 0 ? null : n.normalMap, t.normalMapType = Es, n.normalScale && (t.normalScale = n.normalScale), t.displacementMap = null, t.displacementScale = 1, t.displacementBias = 0, t.specularMap = n.specularMap === void 0 ? null : n.specularMap, t.specular = n.specular, t.glossinessMap = n.glossinessMap === void 0 ? null : n.glossinessMap, t.glossiness = n.glossiness, t.alphaMap = null, t.envMap = n.envMap === void 0 ? null : n.envMap, t.envMapIntensity = 1, t;
  }
}
class wi {
  constructor() {
...
nn.prototype.interpolate_ = function(r, n, t, e) {
  ...
  for (let M = 0; M !== o; M++) {
    const A = i[m + M + o], T = i[m + M + a] * l, O = i[h + M + o], j = i[h + M] * l;
    s[M] = y * A + w * T + g * O + b * j;
  }
  return s;
};
...
function xi(r) {
  ...
  let t;
  return n ? t = "draco:" + n.bufferView + ":" + n.indices + ":" + Dn(n.attributes) : t = r.indices + ":" + Dn(r.attributes) + ":" + r.mode, t;
}
function Dn(r) {
  let n = "";
...
class Ri {
  constructor(n = {}, t = {}) {
    ...
    typeof createImageBitmap > "u" || e || s && i < 98 ? this.textureLoader = new Qn(this.options.manager) : this.textureLoader = new Ts(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new Jt(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(!0);
  }
  setExtensions(n) {
    this.extensions = n;
  }
  ...
  loadAccessor(n) {
    ...
    return s.bufferView !== void 0 ? i.push(this.getDependency("bufferView", s.bufferView)) : i.push(null), s.sparse !== void 0 && (i.push(this.getDependency("bufferView", s.sparse.indices.bufferView)), i.push(this.getDependency("bufferView", s.sparse.values.bufferView))), Promise.all(i).then(function(o) {
      const a = o[0], c = kn[s.type], l = dt[s.componentType], d = l.BYTES_PER_ELEMENT, u = d * c, f = s.byteOffset || 0, h = s.bufferView !== void 0 ? e.bufferViews[s.bufferView].byteStride : void 0, m = s.normalized === !0;
      let g, b;
      if (h && h !== u) {
        const y = Math.floor(f / h), w = "InterleavedBuffer:" + s.bufferView + ":" + s.componentType + ":" + y + ":" + s.count;
        let M = t.cache.get(w);
        M || (g = new l(a, y * h, s.count * h / d), M = new Ss(g, h / d), t.cache.add(w, M)), b = new vs(M, c, f % h / d, m);
      } else
        a === null ? g = new l(s.count * c) : g = new l(a, f, s.count * c), b = new lt(g, c, m);
      if (s.sparse !== void 0) {
        const y = kn.SCALAR, w = dt[s.sparse.indices.componentType], M = s.sparse.indices.byteOffset || 0, A = s.sparse.values.byteOffset || 0, T = new w(o[1], M, s.sparse.count * y), O = new l(o[2], A, s.sparse.count * c);
        a !== null && (b = new lt(b.array.slice(), b.itemSize, b.normalized));
        for (let j = 0, D = T.length; j < D; j++) {
          const K = T[j];
          if (b.setX(K, O[j * c]), c >= 2 && b.setY(K, O[j * c + 1]), c >= 3 && b.setZ(K, O[j * c + 2]), c >= 4 && b.setW(K, O[j * c + 3]), c >= 5)
  ...
  loadTextureImage(n, t, e) {
    ...
    const l = this.loadImageSource(t, e).then(function(d) {
      ...
      return d.magFilter = In[f.magFilter] || Wn, d.minFilter = In[f.minFilter] || Jn, d.wrapS = On[f.wrapS] || Zt, d.wrapT = On[f.wrapT] || Zt, s.associations.set(d, { textures: n }), d;
    }).catch(function() {
      return null;
    });
  ...
  loadImageSource(n, t) {
    ...
    const d = Promise.resolve(c).then(function(u) {
      ...
      return l === !0 && a.revokeObjectURL(c), u.userData.mimeType = o.mimeType || Ai(o.uri), u;
    }).catch(function(u) {
  ...
  loadMaterial(n) {
    ...
    if (d === Xt.BLEND ? (a.transparent = !0, a.depthWrite = !1) : (a.transparent = !1, d === Xt.MASK && (a.alphaTest = i.alphaCutoff !== void 0 ? i.alphaCutoff : 0.5)), i.normalTexture !== void 0 && o !== ye && (l.push(t.assignTexture(a, "normalMap", i.normalTexture)), a.normalScale = new U(1, 1), i.normalTexture.scale !== void 0)) {
      const u = i.normalTexture.scale;
      a.normalScale.set(u, u);
    }
    return i.occlusionTexture !== void 0 && o !== ye && (l.push(t.assignTexture(a, "aoMap", i.occlusionTexture)), i.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = i.occlusionTexture.strength)), i.emissiveFactor !== void 0 && o !== ye && (a.emissive = new V().fromArray(i.emissiveFactor)), i.emissiveTexture !== void 0 && o !== ye && l.push(t.assignTexture(a, "emissiveMap", i.emissiveTexture, Xe)), Promise.all(l).then(function() {
      let u;
  ...
  loadGeometries(n) {
    ...
    for (let a = 0, c = n.length; a < c; a++) {
      const l = n[a], d = xi(l), u = s[d];
      if (u)
        o.push(u.promise);
      else {
        let f;
        l.extensions && l.extensions[I.KHR_DRACO_MESH_COMPRESSION] ? f = i(l) : f = Hn(new B(), l, t), s[d] = { primitive: l, promise: f }, o.push(f);
      }
    }
  ...
  loadMesh(n) {
    ...
    for (let c = 0, l = o.length; c < l; c++) {
      const d = o[c].material === void 0 ? Ti(this.cache) : this.getDependency("material", o[c].material);
      a.push(d);
    }
    return a.push(t.loadGeometries(o)), Promise.all(a).then(function(c) {
      ...
      for (let h = 0, m = d.length; h < m; h++) {
        ...
        if (b.mode === Ae.TRIANGLES || b.mode === Ae.TRIANGLE_STRIP || b.mode === Ae.TRIANGLE_FAN || b.mode === void 0)
          y = i.isSkinnedMesh === !0 ? new As(g, w) : new x(g, w), y.isSkinnedMesh === !0 && !y.geometry.attributes.skinWeight.normalized && y.normalizeSkinWeights(), b.mode === Ae.TRIANGLE_STRIP ? y.geometry = jn(y.geometry, Ns) : b.mode === Ae.TRIANGLE_FAN && (y.geometry = jn(y.geometry, ts));
        ...
        Object.keys(y.geometry.morphAttributes).length > 0 && vi(y, i), y.name = t.createUniqueName(i.name || "mesh_" + n), Ge(y, i), b.extensions && it(s, y, b), t.assignFinalMaterial(y), u.push(y);
      }
  ...
  loadCamera(n) {
    ...
    return e.type === "perspective" ? t = new zn(Rs.radToDeg(s.yfov), s.aspectRatio || 1, s.znear || 1, s.zfar || 2e6) : e.type === "orthographic" && (t = new Un(-s.xmag, s.xmag, s.ymag, -s.ymag, s.znear, s.zfar)), e.name && (t.name = this.createUniqueName(e.name)), Ge(t, e), Promise.resolve(t);
  }
  loadSkin(n) {
  ...
  loadAnimation(n) {
    ...
    return Promise.all([
      ...
      for (let y = 0, w = d.length; y < w; y++) {
        const M = d[y], A = u[y], T = f[y], O = h[y], j = m[y];
        if (M === void 0)
          continue;
        ...
        const K = M.name ? M.name : M.uuid, H = O.interpolation !== void 0 ? Mi[O.interpolation] : es, Z = [];
        De[j.path] === De.weights ? M.traverse(function(X) {
          X.morphTargetInfluences && Z.push(X.name ? X.name : X.uuid);
        }) : Z.push(K);
        let ae = T.array;
        if (T.normalized) {
          const X = Wt(ae.constructor), $ = new Float32Array(ae.length);
          for (let z = 0, ue = ae.length; z < ue; z++)
            $[z] = ae[z] * X;
          ae = $;
        }
        for (let X = 0, $ = Z.length; X < $; X++) {
          ...
          O.interpolation === "CUBICSPLINE" && (z.createInterpolant = function(ee) {
            const re = this instanceof fn ? Ei : nn;
  ...
  loadNode(n) {
    ...
    return function() {
      ...
      let c;
      if (i.isBone === !0 ? c = new Ps() : a.length > 1 ? c = new Ue() : a.length === 1 ? c = a[0] : c = new Tt(), c !== a[0])
  ...
  return e.getDependency("node", r).then(function(i) {
    ...
    return e.getDependency("skin", s.skin).then(function(a) {
      ...
      return i.traverse(function(c) {
        ...
        c.bind(new Cs(l, d), c.matrixWorld);
      }), i;
    });
  }).then(function(i) {
    n.add(i);
...
function Hn(r, n, t) {
  ...
  return Ge(r, n), Li(r, n, t), Promise.all(s).then(function() {
    return n.targets !== void 0 ? Si(r, n.targets, t) : r;
  });
}
function jn(r, n) {
  let t = r.getIndex();
...
const Pi = /* @__PURE__ */ C({
  ...
  setup(r, { expose: n, emit: t }) {
    const e = r, s = new ei(), i = new Ue();
    i.castShadow = !0, i.receiveShadow = !0, Te(i), L(e, "position", i), L(e, "rotation", i), L(e, "scale", i);
    function o() {
      s.load(
        e.url,
        function(c) {
    ...
    ), tn(i.children, e), N("mesh", i), n({
      three: i
    }), (c, l) => J(c.$slots, "default");
  }
}), Ci = /^[og]\s*(.+)?/, Ii = /^mtllib /, Oi = /^usemtl /, ki = /^usemap /, Nn = new v(), Yt = new v(), Fn = new v(), Gn = new v(), he = new v(), Et = new V();
function Di() {
  const r = {
    objects: [],
    object: {},
    ...
    addFaceNormal: function(n, t, e) {
      ...
      Nn.fromArray(s, n), Yt.fromArray(s, t), Fn.fromArray(s, e), he.subVectors(Fn, Yt), Gn.subVectors(Nn, Yt), he.cross(Gn), he.normalize(), i.push(he.x, he.y, he.z), i.push(he.x, he.y, he.z), i.push(he.x, he.y, he.z);
    },
    ...
    if (l.materialLibraries = [].concat(t.materialLibraries), !(t.objects.length === 1 && t.objects[0].geometry.vertices.length === 0) === !0)
      for (let u = 0, f = t.objects.length; u < f; u++) {
        ...
        if (m.vertices.length === 0)
          continue;
        const M = new B();
        M.setAttribute("position", new ge(m.vertices, 3)), m.normals.length > 0 && M.setAttribute("normal", new ge(m.normals, 3)), m.colors.length > 0 && (w = !0, M.setAttribute("color", new ge(m.colors, 3))), m.hasUVIndices === !0 && M.setAttribute("uv", new ge(m.uvs, 2));
        const A = [];
        for (let O = 0, j = g.length; O < j; O++) {
          const D = g[O], K = D.name + "_" + D.smooth + "_" + w;
          let H = t.materials[K];
          if (this.materials !== null) {
            if (H = this.materials.create(D.name), b && H && !(H instanceof Pe)) {
              const Z = new Pe();
              ut.prototype.copy.call(Z, H), Z.color.copy(H.color), H = Z;
            } else if (y && H && !(H instanceof ze)) {
              const Z = new ze({ size: 10, sizeAttenuation: !1 });
              ut.prototype.copy.call(Z, H), Z.color.copy(H.color), Z.map = H.map, H = Z;
            }
          }
          H === void 0 && (b ? H = new Pe() : y ? H = new ze({ size: 1, sizeAttenuation: !1 }) : H = new Us(), H.name = D.name, H.flatShading = !D.smooth, H.vertexColors = w, t.materials[K] = H), A.push(H);
        }
        let T;
        if (A.length > 1) {
          for (let O = 0, j = g.length; O < j; O++) {
          ...
          b ? T = new St(M, A) : y ? T = new ct(M, A) : T = new x(M, A);
        } else
          b ? T = new St(M, A[0]) : y ? T = new ct(M, A[0]) : T = new x(M, A[0]);
        T.name = h.name, l.add(T);
      }
    else if (t.vertices.length > 0) {
      const u = new ze({ size: 1, sizeAttenuation: !1 }), f = new B();
      f.setAttribute("position", new ge(t.vertices, 3)), t.colors.length > 0 && t.colors[0] !== void 0 && (f.setAttribute("color", new ge(t.colors, 3)), u.vertexColors = !0);
      const h = new ct(f, u);
      l.add(h);
    }
    return l;
...
const ji = /* @__PURE__ */ C({
  ...
  emits: ["load", "progress", "error"],
  setup(r, { expose: n, emit: t }) {
    const e = r, s = new Hi(), i = new Ue();
    Te(i), L(e, "position", i), L(e, "rotation", i), L(e, "scale", i);
    function o() {
      s.load(
        e.url,
        function(c) {
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new Bs(t.size);
    return e.add(s), L(t, "position", s), L(t, "rotation", s), L(t, "scale", s), N("mesh", s), n({ three: s }), (i, o) => J(i.$slots, "default");
  }
}), Fi = /* @__PURE__ */ C({
  __name: "BoxHelper",
  props: {
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new B(), i = new ye(), o = new x(s, i);
    Te(o), L(t, "position", o), L(t, "rotation", o), L(t, "scale", o);
    function a() {
      o.castShadow = t.castShadow, o.receiveShadow = t.receiveShadow;
    }
    a(), _(t, "castShadow", a), _(t, "receiveShadow", a);
  ...
  setup(r, { expose: n }) {
    ...
    function a() {
      ...
      pe(s, c), k.geometryChanged(t.name, s), i && k.object3DChanged(i.name, i);
    }
  ...
  setup(r, { expose: n }) {
    const t = r, e = fe(new B()), s = S("mesh", null);
    s && (s.geometry = e);
...
class It extends B {
  constructor(n = (s, i, o) => o.set(s, i, Math.cos(s) * Math.sin(i)), t = 8, e = 8) {
    ...
    this.setIndex(s), this.setAttribute("position", new ge(i, 3)), this.setAttribute("normal", new ge(o, 3)), this.setAttribute("uv", new ge(a, 2));
  }
}
const Ke = {
...
const Wi = {
  ...
  setup(r, { expose: n }) {
    ...
    return o(), _(t, "color", o), _(t, "opacity", o), _(t, "transparent", o), N("material", e), n({
      three: e
  ...
  setup(r, { expose: n }) {
    const t = r, e = new Ks({ color: t.color });
    e.name = t.name;
    const s = S("addMaterial");
    s(e);
    const i = S("mesh", null);
    ...
    return o(), _(t, "color", o), _(t, "scale", o), _(t, "dashSize", o), _(t, "gapSize", o), _(t, "opacity", o), _(t, "transparent", o), N("material", e), n({
      three: e
    }), { props: t, three: e, addMaterial: s, mesh: i, applyProps: o };
  }
}), ha = {
  ...
  setup(r, { expose: n }) {
    ...
    return o(), N("material", e), _(t, "color", o), _(t, "side", o), _(t, "opacity", o), _(t, "transparent", o), _(t, "vertexColors", o), n({
      three: e
    }), (a, c) => J(a.$slots, "default");
  }
}), pa = {
  ...
  setup(r, { expose: n }) {
    ...
    return o(), _(t, "color", o), _(t, "size", o), _(t, "sizeAttenuation", o), _(t, "opacity", o), _(t, "transparent", o), N("material", e), n({
      three: e
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new Kn();
    e.add(s);
    function i() {
      s.color = new V(t.color), s.intensity = t.intensity;
    }
    return i(), _(t, "color", i), _(t, "intensity", i), n({ three: s }), { props: t, scene: e, three: s, applyProps: i };
  }
}), Sa = {
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("scene"), s = new qn();
    e.add(s), L(t, "position", s), L(t, "rotation", s), L(t, "scale", s);
    function i(o) {
      s.color = new V(o.color), s.intensity = o.intensity, s.castShadow = o.castShadow;
    }
    return i(t), F(
      () => t.color,
      () => i(t)
  ...
  setup(r, { expose: n }) {
    const t = r, e = S("material"), s = He(new qt());
    function i() {
      new Qn().loadAsync(t.url).then((a) => {
        s.value = a, _n(t, "offset", s.value), _n(t, "repeat", s.value), "map" in e && (e.map = s.value, e.needsUpdate = !0), o();
      });
    }
    function o() {
...
function Ha(r) {
  r.component("Renderer", vo), r.component("Scene", xo), r.component("PerspectiveCamera", Ro), r.component("OrthographicCamera", Po), r.component("OrbitControls", Oo), r.component("TrackballControls", Ho), r.component("TransformControls", Vo), r.component("Group", Zo), r.component("InstancedMesh", $o), r.component("Line", qo), r.component("LineLoop", Ko), r.component("LineSegments", Qo), r.component("Mesh", Wo), r.component("Points", Jo), r.component("GLTFLoader", Pi), r.component("OBJLoader", ji), r.component("AxesHelper", Ni), r.component("BoxHelper", Fi), r.component("BoxGeometry", zi), r.component("BufferGeometry", Bi), r.component("CircleGeometry", Yi), r.component("ConeGeometry", Zi), r.component("CylinderGeometry", qi), r.component("EdgesGeometry", Qi), r.component("ParametricGeometry", Ji), r.component("PlaneGeometry", ta), r.component("RingGeometry", sa), r.component("SphereGeometry", ia), r.component("WireframeGeometry", ra), r.component("LineBasicMaterial", la), r.component("LineDashedMaterial", da), r.component("MeshBasicMaterial", fa), r.component("MeshLambertMaterial", ma), r.component("PointsMaterial", ya), r.component("MeshNormalMaterial", wa), r.component("AmbientLight", Ea), r.component("DirectionalLight", Ta), r.component("HemisphereLight", va), r.component("PointLight", Aa), r.component("TextureLoader", La);
}
export {
  Ea as AmbientLight,
  Ni as AxesHelper,
  zi as BoxGeometry,
  Fi as BoxHelper,
  Bi as BufferGeometry,
  Yi as CircleGeometry,
  Zi as ConeGeometry,
  qi as CylinderGeometry,
  Ta as DirectionalLight,
  Qi as EdgesGeometry,
  Pi as GLTFLoader,
  Zo as Group,
  va as HemisphereLight,
  $o as InstancedMesh,
  qo as Line,
  la as LineBasicMaterial,
  da as LineDashedMaterial,
  Ko as LineLoop,
  Qo as LineSegments,
  Wo as Mesh,
  fa as MeshBasicMaterial,
  ma as MeshLambertMaterial,
  wa as MeshNormalMaterial,
  ji as OBJLoader,
  Oo as OrbitControls,
  Po as OrthographicCamera,
  Ji as ParametricGeometry,
  Ro as PerspectiveCamera,
  ta as PlaneGeometry,
  Aa as PointLight,
  Jo as Points,
  ya as PointsMaterial,
  vo as Renderer,
  sa as RingGeometry,
  xo as Scene,
  ia as SphereGeometry,
  La as TextureLoader,
  Ho as TrackballControls,
  Vo as TransformControls,
  ra as WireframeGeometry,
  Ha as install
};
