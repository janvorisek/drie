...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    three: import("vue").Ref<{
        ...
        sizeAttenuation: boolean;
        fog: boolean;
        setValues: (parameters: import("three").PointsMaterialParameters) => void;
        alphaTest: number;
        ...
        copy: (material: import("three").Material) => PointsMaterial;
        dispose: () => void;
        onBeforeCompile: (shader: import("three").Shader, renderer: import("three").WebGLRenderer) => void;
        customProgramCacheKey: () => string;
        toJSON: (meta?: any) => any;
        addEventListener: <T_3 extends string>(type: T_3, listener: import("three").EventListener<import("three").Event, T_3, PointsMaterial>) => void;
        hasEventListener: <T_4 extends string>(type: T_4, listener: import("three").EventListener<import("three").Event, T_4, PointsMaterial>) => boolean;
        removeEventListener: <T_5 extends string>(type: T_5, listener: import("three").EventListener<import("three").Event, T_5, PointsMaterial>) => void;
        dispatchEvent: (event: import("three").Event) => void;
    }>;
