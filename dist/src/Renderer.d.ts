...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    cameras: Ref<{
        ...
        parent: {
            ...
            onBeforeRender: (renderer: WebGLRenderer, scene: Scene, camera: Camera, geometry: import("three").BufferGeometry, material: import("three").Material, group: import("three").Group) => void;
            onAfterRender: (renderer: WebGLRenderer, scene: Scene, camera: Camera, geometry: import("three").BufferGeometry, material: import("three").Material, group: import("three").Group) => void;
